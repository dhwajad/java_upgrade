...
public class FunctionalInterfacesTest {
    ...
    public void constructorReference() throws Exception {
        ...
        Set<String> strings = stringList.stream().collect(Collectors.toSet());
        assertEquals(4, strings.size());
        assertEquals(HashSet.class, strings.getClass());

        // Add the strings to a TreeSet

        TreeSet<String> sortedStrings = stringList.stream().collect(Collectors.toCollection(TreeSet::new));
